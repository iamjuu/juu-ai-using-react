    ...
    (<div
      ...
      <div className="h-auto  relative  overflow-hidden">
        <motion.div
          ...
          className="absolute bg-[#303030be] z-20  will-change-transform">
          <p
            style={{
              textShadow: "4px 4px 15px rgb(0, 0, 0)",
            }}
...
export const TextRevealCardDescription = ({
  ...
  return (<p className={twMerge("   flex  items-center justify-center text-[#7676760d] text-sm", className)}>{children}</p>);
};
